...
Location: type/file/1.0.0/analysis_file
...
Location: type/file/1.0.0/sequence_file
...
Location: type/file/1.0.0/supplementary_file
...
Location: type/protocol/sequencing/1.0.0/library_preparation_protocol
...
Location: type/protocol/sequencing/1.0.0/sequencing_protocol
...
Location: type/protocol/analysis/1.0.0/analysis_protocol
...
Location: type/protocol/biomaterial_collection/1.0.0/aggregate_generation_protocol
...
Location: type/protocol/biomaterial_collection/1.0.0/ipsc_induction_protocol
...
Location: type/protocol/biomaterial_collection/1.0.0/gene_expression_alteration_protocol
...
provenance | Provenance information provided by the system. | object | no | [See system  provenance](system.md#provenance) |  |  | 
protocol_core | Core protocol-level information. | object | yes | [See core  protocol_core](core.md#protocol-core) | Protocol core |  | 
method | Method applied to the biomaterial to induce a LOF on the gene/allele of interest. | array | yes | [See module  gene_silencing_method_ontology](module.md#gene-silencing-method-ontology) | Treatment method |  | 
crisproff | CRISPRoff specific fields | array | no | [See module  crisproff](module.md#crisproff) | CRISPRoff |  | 
silenced_genes | Genes that were silenced by this protocol | array | no | [See module  target_gene_ontology](module.md#target-gene-ontology) | Silenced Gene(s) |  | 

## Dissociation protocol
_Information about the dissociation protocol used to separate individual cells or nuclei._

Location: type/protocol/biomaterial_collection/1.0.0/dissociation_protocol
...
Location: type/protocol/biomaterial_collection/1.0.0/differentiation_protocol
...
Location: type/protocol/biomaterial_collection/1.0.0/enrichment_protocol
...
Location: type/protocol/imaging/1.0.0/imaging_protocol
...
Location: type/protocol/imaging/1.0.0/imaging_preparation_protocol
...
Location: type/project/1.0.0/project
...
insdc_project_accessions | An International Nucleotide Sequence Database Collaboration (INSDC) project accession. | array | no |  | INSDC project accession |  | PRJEB000000
...
target_genes_hgnc_ids | HGNC ID(s) of the gene(s) that were studied in this project. | array | no | [See module  target_gene_ontology](module.md#target-gene-ontology) | Target gene(s) HGNC ID(s) |  | 

## Organoid
_Information about an organoid biomaterial._

Location: type/biomaterial/1.0.0/organoid
...
Location: type/biomaterial/1.0.0/donor_organism
...
Location: type/biomaterial/1.0.0/cell_line
...
genbank_assembly_accession | A GenBank assembly accession identifier for the cell line. | string | no |  | Genbank assembly accession |  | GCA_000001405.29
cellosaurus_accession | A Cellosaurus ID from Expasy | string | no |  | Cellosaurus accession |  | CVCL_0132

## Cell suspension
_Information about the suspension of cells or nuclei derived from the collected or cultured specimen._

Location: type/biomaterial/1.0.0/cell_suspension
...
Location: type/process/1.0.0/process
